...
`beryl-worker` owns local block storage and metadata-authorized data-plane execution. Worker code does not own namespace visibility or file layout decisions.
...
- For focused checks, use `cargo test -p beryl-worker`.
