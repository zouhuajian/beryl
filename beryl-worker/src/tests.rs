...
mod tests {
    ...
    use beryl_types::ids::{BlockId, BlockIndex, ChunkIndex, ClientId, DataHandleId, StreamId, WorkerId};
    ...
    fn core_does_not_import_wire_types() {
        ...
        for forbidden in ["beryl_proto::", "prost", "tonic"] {
    ...
    fn worker_data_proto_excludes_old_chunk_range_api() {
        let sources = [
            include_str!("../../beryl-proto/worker/data.proto"),
    ...
    fn worker_write_proto_fields_are_normalized() {
        let proto = include_str!("../../beryl-proto/worker/data.proto");
