...
fn production_worker_lookup_sources_reject_implicit_group_patterns() {
    let sources = [
        ("beryl-metadata/src/worker/manager.rs", include_str!("manager.rs")),
        (
            "beryl-metadata/src/raft/storage/mod.rs",
            include_str!("../raft/storage/mod.rs"),
        ),
        (
            "beryl-metadata/src/raft/storage/query.rs",
            include_str!("../raft/storage/query.rs"),
        ),
        (
            "beryl-metadata/src/raft/storage/transaction.rs",
            include_str!("../raft/storage/transaction.rs"),
        ),
        (
            "beryl-metadata/src/service/filesystem/read.rs",
        ...
        (
            "beryl-metadata/src/maintenance/repair/actions.rs",
            include_str!("../maintenance/repair/actions.rs"),
        ),
        (
            "beryl-metadata/src/maintenance/repair/types.rs",
