...
#[test]
fn file_layout_validation_rejects_invalid_shapes() {
    for layout in [
        FileLayout::new(0, 1024, 1),
        FileLayout::new(4096, 0, 1),
        FileLayout::new(4096, 8192, 1),
        FileLayout::new(4097, 1024, 1),
        FileLayout::new(4096, 1024, 0),
    ] {
