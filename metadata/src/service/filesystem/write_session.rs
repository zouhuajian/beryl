...
use common::error::rpc::{ErrorKind, MetadataErrorKind};
...
use types::{BlockShape, GroupName, Tier, WorkerEndpointInfo, WriteTarget};
...
mod tests {
    ...
    async fn abort_checks_handle() {
        ...
        let roundtrip_error = proto::convert::rpc_error_from_proto(
