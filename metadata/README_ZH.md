...
flowchart TB
    ...
    WorkerRt --> Repair["maintenance/repair queues/planner"]
...
- leader 分配 full block report lease，经 `WorkerCommandRouter` 处理 task ack 并从 DeleteExecutor/RepairQueue 拉取 worker command。
