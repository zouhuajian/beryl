...
pub(crate) fn worker_error_kind(error: &WorkerError) -> &'static str {
    match error {
        ...
        WorkerError::NeedRefresh { reason, .. } => match reason {
            common::error::canonical::RefreshReason::NotLeader => "not_leader",
            common::error::canonical::RefreshReason::OwnerGroupMismatch => "owner_group_mismatch",
            common::error::canonical::RefreshReason::Moved => "moved",
            common::error::canonical::RefreshReason::RouteEpochMismatch => "route_epoch_mismatch",
            common::error::canonical::RefreshReason::MountEpochMismatch => "mount_epoch_mismatch",
            common::error::canonical::RefreshReason::WorkerRunMismatch => "worker_run_mismatch",
            common::error::canonical::RefreshReason::NeedRegister => "need_register",
            ...
            common::error::canonical::RefreshReason::SessionInvalid => "session_invalid",
            common::error::canonical::RefreshReason::SessionExpired => "session_expired",
            common::error::canonical::RefreshReason::Unknown => "unknown_refresh",
        },
    ...
    fn store_report_uses_capacity_kinds_and_separate_writable_metric() {
        ...
        let report = StoreReport {
            ...
            dirs: vec![crate::store::dirs::StoreDirReport {
                id: "hdd0".to_string(),
                path: std::path::PathBuf::from("/tmp/vecton-worker/hdd0"),
                tier: types::Tier::Hdd,
                capacity_bytes: 100,
                used_bytes: 40,
                pending_bytes: 7,
