...
use beryl_types::{CommittedBlock, DataHandleId, FileLayout};
...
impl OperationExecutor {
    ...
    pub(crate) async fn open_file(&self, path: NamespacePathBuf) -> ClientResult<ReadHandle> {
        ...
        let request = beryl_proto::metadata::OpenFileRequestProto {
            header: None,
            path: path.clone(),
        };
        let response = self
    ...
    pub(crate) async fn append_file(&self, path: NamespacePathBuf) -> ClientResult<WriteHandle> {
        ...
        let response = self
            .append_file_request(
                &path,
                beryl_proto::metadata::AppendFileRequestProto {
                    header: None,
                    path: path.clone(),
                    desired_len: Some(default_write_preallocation_len()),
                },
    ...
    pub(crate) async fn add_block(
        ...
        let req = beryl_proto::metadata::AddBlockRequestProto {
            header: None,
    ...
    pub(crate) async fn abort_file_write(
        ...
        let req = beryl_proto::metadata::AbortFileWriteRequestProto {
            header: None,
            write_handle: Some(write_handle),
        };
        self.execute_metadata(operation, req, |gateway, ctx, req| async move {
    ...
    pub(crate) async fn renew_lease(
        ...
        let req = beryl_proto::metadata::RenewLeaseRequestProto {
            header: None,
            write_handle: Some(write_handle),
        };
        self.execute_metadata(operation, req, |gateway, ctx, req| async move {
...
mod tests {
    ...
    async fn add_block_session_expired_is_not_replayed_as_refresh() {
        ...
        let err = executor
            .add_block(
                "/alpha",
                "handle=1".to_string(),
                beryl_proto::metadata::WriteHandleProto::default(),
                5,
            )
            .await
    ...
    async fn commit_file_fencing_is_not_replayed_as_refresh() {
        ...
        let plan = CommitFilePlan {
            operation,
            write_handle: beryl_proto::metadata::WriteHandleProto::default(),
    ...
    impl MetadataGateway for ScriptedGateway {
        ...
        async fn list_status(
            ...
            Ok(beryl_proto::metadata::ListStatusResponseProto::default())
        }

        async fn create_directory(
            &self,
            ctx: AttemptContext,
            _req: beryl_proto::metadata::CreateDirectoryRequestProto,
        ) -> ClientResult<beryl_proto::metadata::CreateDirectoryResponseProto> {
            self.next_result("create_directory", &ctx).await?;
            Ok(beryl_proto::metadata::CreateDirectoryResponseProto::default())
        }
        ...
        async fn rename(
            ...
            Ok(beryl_proto::metadata::RenameResponseProto::default())
        }
        ...
        async fn open_file(
            ...
            Ok(beryl_proto::metadata::OpenFileResponseProto::default())
        }

        async fn read_layout(
            &self,
            ctx: AttemptContext,
            _req: beryl_proto::metadata::GetBlockLocationsRequestProto,
        ) -> ClientResult<ReadLayout> {
        ...
        async fn add_block(
            &self,
            ctx: AttemptContext,
            _req: beryl_proto::metadata::AddBlockRequestProto,
        ) -> ClientResult<AddBlockResult> {
        ...
        async fn commit_file(
            &self,
            ctx: AttemptContext,
            _req: beryl_proto::metadata::CommitFileRequestProto,
        ) -> ClientResult<beryl_proto::metadata::CommitFileResponseProto> {
        ...
        async fn sync_write(
            &self,
            ctx: AttemptContext,
            _req: beryl_proto::metadata::SyncWriteRequestProto,
        ) -> ClientResult<beryl_proto::metadata::SyncWriteResponseProto> {
            self.next_result("sync_write", &ctx).await?;
            Ok(beryl_proto::metadata::SyncWriteResponseProto::default())
        }
